...
class App extends Component {
  ...
  updateUserTokens=async ()=>{
    let userToken=await this.tokenInstance.methods.balnceOf(this.accounts[0]).call();
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button type="button" onClick={this.handleBuyMoreTokens}>Buy More tokens</button>
      </div>
    );
  }
}
